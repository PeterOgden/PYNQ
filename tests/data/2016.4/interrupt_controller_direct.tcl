...
################################################################
# This is a generated script based on design: interrupt_controller_direct
#
...
# source interrupt_controller_direct_script.tcl
...
set design_name interrupt_controller_direct
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_net -net axi_intc_0_irq [get_bd_pins pynq_interrupts/irq] [get_bd_pins system_interrupts/In0]
  ...
  connect_bd_net -net pynq_test_interrupt_wire [get_bd_pins pynq_interrupts/intr] [get_bd_pins pynq_test/interrupt_wire]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_interrupts/dout]
...
preplace inst pynq_test -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 250 -defaultsOSRD
preplace inst system_interrupts -pg 1 -lvl 4 -y 460 -defaultsOSRD
preplace inst pynq_interrupts -pg 1 -lvl 3 -y 370 -defaultsOSRD
...
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 730 50 1100
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 390 270 690J 20 NJ 20 NJ 20 1890
preplace netloc xlconcat_1_dout 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 20 340 390J 290 NJ 290 NJ 290 NJ 290 1880
...
preplace netloc pynq_test_interrupt_wire 1 2 2 730 270 1100
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 3 370 280 NJ 280 1120J
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 3 380 380 720 250 1130
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 10 550 360 550 710 550 1110 550 1430 550 1870
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 700
preplace netloc axi_intc_0_irq 1 3 1 1100
levelinfo -pg 1 -10 190 550 920 1290 1650 1910 -top 0 -bot 560
",
}
