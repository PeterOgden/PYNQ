...
################################################################
# This is a generated script based on design: hierarchy
#
...
proc create_hier_cell_hier { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr interrupt_bus
  create_bd_pin -dir O interrupt_wire
  ...
  connect_bd_net -net inner_interrupt_bus [get_bd_pins interrupt_bus] [get_bd_pins inner/interrupt_bus]
  connect_bd_net -net inner_interrupt_wire [get_bd_pins interrupt_wire] [get_bd_pins inner/interrupt_wire]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clock] [get_bd_pins inner/clock]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins reset_n] [get_bd_pins inner/reset_n]
...
preplace port gpio_in -pg 1 -y 100 -defaultsOSRD
preplace port S_AXI_CTRL -pg 1 -y 40 -defaultsOSRD
preplace port clock -pg 1 -y 120 -defaultsOSRD
preplace port interrupt_wire -pg 1 -y 140 -defaultsOSRD
preplace port reset_n -pg 1 -y 140 -defaultsOSRD
preplace port interrupt_bus -pg 1 -y 120 -defaultsOSRD
preplace inst inner -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace netloc inner_M_AXI_OUT 1 0 2 10 -10 370
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 1 NJ
preplace netloc inner_interrupt_wire 1 1 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 1 NJ
preplace netloc inner_M_AXI_DRAM 1 1 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 1 NJ
preplace netloc inner_interrupt_bus 1 1 1 NJ
preplace netloc xlslice_0_Dout 1 0 1 NJ
levelinfo -pg 1 -10 190 390 -top -20 -bot 190
",
}
...
CONFIG.C_IRQ_CONNECTION {1} \
  ...
  # Create instance: pynq_slice, and set properties
  set pynq_slice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 pynq_slice ]
  set_property -dict [ list \
CONFIG.DIN_FROM {2} \
CONFIG.DIN_TO {2} \
CONFIG.DIN_WIDTH {64} \
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net inner_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins hier/M_AXI_DRAM]
  ...
  connect_bd_net -net inner_interrupt_bus [get_bd_pins hier/interrupt_bus] [get_bd_pins pynq_concat/In0]
  connect_bd_net -net inner_interrupt_wire [get_bd_pins hier/interrupt_wire] [get_bd_pins pynq_concat/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins hier/clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_interrupts/s_axi_aclk] [get_bd_pins pynq_test/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins pynq_slice/Din]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins hier/reset_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_interrupts/s_axi_aresetn] [get_bd_pins pynq_test/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins hier/gpio_in] [get_bd_pins pynq_slice/Dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier/inner/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_inner_S_AXI_CTRL_reg
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces hier/inner/M_AXI_DRAM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace inst pynq_test -pg 1 -lvl 4 -y 100 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 490 -defaultsOSRD
preplace inst system_concat -pg 1 -lvl 4 -y 320 -defaultsOSRD
preplace inst pynq_concat -pg 1 -lvl 2 -y 230 -defaultsOSRD
preplace inst pynq_interrupts -pg 1 -lvl 1 -y 230 -defaultsOSRD
preplace inst hier -pg 1 -lvl 7 -y 190 -defaultsOSRD
preplace inst pynq_slice -pg 1 -lvl 3 -y 110 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y 330 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 330 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -y 370 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 0 4 20 580 NJ 580 NJ 580 940
preplace netloc processing_system7_0_DDR 1 6 10 NJ 330 NJ 330 NJ 330 NJ 330 NJ 330 NJ 330 NJ 330 NJ 330 NJ 330 2870
preplace netloc pynq_test_0_M_AXI_OUT 1 3 2 990 200 1360
preplace netloc processing_system7_0_GPIO_O 1 2 5 610 -10 NJ -10 NJ -10 NJ -10 2170
preplace netloc processing_system7_0_M_AXI_GP0 1 2 5 650J 540 NJ 540 NJ 540 NJ 540 2180
preplace netloc xlconcat_1_dout 1 4 2 1360J 480 1730J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 50 610 NJ 610 NJ 610 NJ 610 NJ 610 NJ 610 2170
preplace netloc pynq_test_0_M_AXI_DRAM 1 4 1 1400
preplace netloc axi_mem_intercon_M00_AXI 1 5 1 1720
preplace netloc ps7_0_axi_periph_M01_AXI 1 3 4 970J 220 1370J 160 NJ 160 N
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 4 NJ 510 630J 510 NJ 510 1380J
preplace netloc xlconcat_0_dout 1 0 3 50 310 NJ 310 610
preplace netloc inner_interrupt_wire 1 1 7 400 -20 NJ -20 NJ -20 NJ -20 NJ -20 NJ -20 2470
preplace netloc processing_system7_0_FIXED_IO 1 6 10 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 2880
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 7 40 600 390 600 640 600 980 600 1390 600 NJ 600 2200
preplace netloc inner_M_AXI_DRAM 1 4 4 1400 550 NJ 550 NJ 550 2460
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 30 590 N 590 620 590 960 590 1370 590 1720 590 2190
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 940
preplace netloc axi_intc_0_irq 1 1 3 390J 490 NJ 490 990J
preplace netloc inner_interrupt_bus 1 1 7 390 -40 NJ -40 NJ -40 NJ -40 NJ -40 NJ -40 2480
preplace netloc xlslice_0_Dout 1 3 4 950J 210 1380J 180 NJ 180 N
levelinfo -pg 1 0 220 520 800 1180 1580 1950 2330 2500 2550 2600 2650 2700 2750 2800 2850 2900 -top -170 -bot 630
",
}
