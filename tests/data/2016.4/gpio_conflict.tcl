...
################################################################
# This is a generated script based on design: gpio_conflict
#
...
# source gpio_conflict_script.tcl
...
CONFIG.NUM_MI {2} \
  ...
  # Create instance: pynq_slice_0, and set properties
  set pynq_slice_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 pynq_slice_0 ]
  set_property -dict [ list \
CONFIG.DIN_FROM {2} \
CONFIG.DIN_TO {2} \
CONFIG.DIN_WIDTH {64} \
CONFIG.DOUT_WIDTH {1} \
  ...
  # Create instance: pynq_slice_1, and set properties
  set pynq_slice_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 pynq_slice_1 ]
  set_property -dict [ list \
CONFIG.DIN_FROM {2} \
CONFIG.DIN_TO {2} \
CONFIG.DIN_WIDTH {64} \
CONFIG.DOUT_WIDTH {1} \
  ...
  # Create instance: pynq_test_0, and set properties
  set pynq_test_0 [ create_bd_cell -type ip -vlnv user.org:user:pynq_test:1.0 pynq_test_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pynq_test_0/S_AXI_CTRL]
  connect_bd_intf_net -intf_net pynq_test1_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins pynq_test_0/M_AXI_DRAM]
  connect_bd_intf_net -intf_net pynq_test1_M_AXI_OUT [get_bd_intf_pins pynq_test_0/M_AXI_OUT] [get_bd_intf_pins pynq_test_0/S_AXI_IN]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_test_0/clock] [get_bd_pins pynq_test_1/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins pynq_slice_0/Din] [get_bd_pins pynq_slice_1/Din]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_test_0/reset_n] [get_bd_pins pynq_test_1/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins pynq_slice_1/Dout] [get_bd_pins pynq_test_1/gpio_in]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins pynq_slice_0/Dout] [get_bd_pins pynq_test_0/gpio_in]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_test_0/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test1_S_AXI_CTRL_reg
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces pynq_test_0/M_AXI_DRAM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 270 -defaultsOSRD
preplace inst pynq_slice_0 -pg 1 -lvl 3 -y 320 -defaultsOSRD
preplace inst pynq_slice_1 -pg 1 -lvl 2 -y 290 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst pynq_test_0 -pg 1 -lvl 1 -y 50 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 200 -defaultsOSRD
preplace inst pynq_test_1 -pg 1 -lvl 3 -y 190 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 170 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 1 NJ
preplace netloc xlslice_1_Dout 1 0 4 -20 -80 NJ -80 NJ -80 1130
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 760 370 1120
preplace netloc processing_system7_0_GPIO_O 1 1 5 410 340 720J 20 NJ 20 NJ 20 1910
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 410 -70 NJ -70 NJ -70 NJ -70 1920
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 0 400 NJ 400 NJ 400 NJ 400 NJ 400 1910
preplace netloc pynq_test_0_M_AXI_DRAM 1 3 1 1140
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1460
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 3 -10 -60 NJ -60 710
preplace netloc pynq_test1_M_AXI_OUT 1 0 2 0 -50 370
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 3 380 -40 NJ -40 1160
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 4 -10 390 400 390 750 390 1180
preplace netloc pynq_test1_M_AXI_DRAM 1 1 3 400J -20 NJ -20 1150
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 -20 380 390 380 740 380 1170 380 1470 380 1920
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 760
preplace netloc xlslice_0_Dout 1 2 1 730J
levelinfo -pg 1 -40 190 570 940 1320 1690 1940 -top -90 -bot 410
",
}
