...
################################################################
# This is a generated script based on design: interrupt_standard
#
...
# source interrupt_standard_script.tcl
...
set design_name interrupt_standard
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pynq_interrupts/s_axi]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_interrupts/s_axi_aclk] [get_bd_pins pynq_test/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pynq_test_interrupt_bus [get_bd_pins pynq_concat/In0] [get_bd_pins pynq_test/interrupt_bus]
  connect_bd_net -net pynq_test_interrupt_wire [get_bd_pins pynq_concat/In1] [get_bd_pins pynq_test/interrupt_wire]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_interrupts/s_axi_aresetn] [get_bd_pins pynq_test/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
...
preplace inst pynq_test -pg 1 -lvl 3 -y 160 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 250 -defaultsOSRD
preplace inst system_concat -pg 1 -lvl 5 -y 280 -defaultsOSRD
preplace inst pynq_concat -pg 1 -lvl 2 -y 360 -defaultsOSRD
preplace inst pynq_interrupts -pg 1 -lvl 3 -y 340 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 550 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -y 570 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 6 1 NJ
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 720 60 1100
preplace netloc processing_system7_0_M_AXI_GP0 1 1 6 360 -10 NJ -10 NJ -10 NJ -10 N -10 2040
preplace netloc xlconcat_1_dout 1 5 1 1590
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 10 -20 NJ -20 NJ -20 NJ -20 NJ -20 N -20 2050
preplace netloc pynq_test_0_M_AXI_DRAM 1 3 1 1120
preplace netloc axi_mem_intercon_M00_AXI 1 4 2 N 550 N
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 700
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 3 370 530 NJ 530 NJ
preplace netloc pynq_test_interrupt_wire 1 1 3 390 420 NJ 420 1100
preplace netloc xlconcat_0_dout 1 2 1 700
preplace netloc pynq_test_interrupt_bus 1 1 3 390 300 690J 50 1110
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 3 380 570 720 570 1110
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 20 700 360 700 710 700 1120 700 N 700 1600 700 2040
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 700
preplace netloc axi_intc_0_irq 1 3 2 N 340 1400J
levelinfo -pg 1 -10 190 550 920 1260 1500 1820 2070 -top -30 -bot 720
",
}
