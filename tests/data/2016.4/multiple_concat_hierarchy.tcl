...
################################################################
# This is a generated script based on design: multiple_concat_hierarchy
#
...
# source multiple_concat_hierarchy_script.tcl
...
set design_name multiple_concat_hierarchy
...
proc create_hier_cell_hier { parentCell nameHier } {
  ...
  # Create instance: inner_concat, and set properties
  set inner_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 inner_concat ]

  # Create instance: pynq_test_2, and set properties
  set pynq_test_2 [ create_bd_cell -type ip -vlnv user.org:user:pynq_test:1.0 pynq_test_2 ]

  # Create interface connections
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI_CTRL] [get_bd_intf_pins pynq_test_2/S_AXI_CTRL]
  connect_bd_intf_net -intf_net pynq_test_2_M_AXI_DRAM [get_bd_intf_pins M_AXI_DRAM] [get_bd_intf_pins pynq_test_2/M_AXI_DRAM]
  connect_bd_intf_net -intf_net pynq_test_2_M_AXI_OUT [get_bd_intf_pins pynq_test_2/M_AXI_OUT] [get_bd_intf_pins pynq_test_2/S_AXI_IN]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clock] [get_bd_pins pynq_test_2/clock]
  connect_bd_net -net pynq_test_2_interrupt_bus [get_bd_pins inner_concat/In0] [get_bd_pins pynq_test_2/interrupt_bus]
  connect_bd_net -net pynq_test_2_interrupt_wire [get_bd_pins inner_concat/In1] [get_bd_pins pynq_test_2/interrupt_wire]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins reset_n] [get_bd_pins pynq_test_2/reset_n]
  connect_bd_net -net xlconcat_3_dout [get_bd_pins dout] [get_bd_pins inner_concat/dout]

  # Perform GUI Layout
  regenerate_bd_layout -hierarchy [get_bd_cells /hier] -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port M_AXI_DRAM -pg 1 -y 40 -defaultsOSRD
preplace port S_AXI_CTRL -pg 1 -y 40 -defaultsOSRD
preplace port clock -pg 1 -y 120 -defaultsOSRD
preplace port reset_n -pg 1 -y 140 -defaultsOSRD
preplace portBus dout -pg 1 -y 130 -defaultsOSRD
preplace inst pynq_test_2 -pg 1 -lvl 1 -y 90 -defaultsOSRD
preplace inst inner_concat -pg 1 -lvl 2 -y 130 -defaultsOSRD
preplace netloc pynq_test_2_M_AXI_OUT 1 0 2 10 -10 370
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 1 NJ
preplace netloc xlconcat_3_dout 1 2 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 1 NJ
preplace netloc pynq_test_2_interrupt_bus 1 1 1 N
preplace netloc pynq_test_2_interrupt_wire 1 1 1 N
preplace netloc pynq_test_2_M_AXI_DRAM 1 1 2 NJ 40 NJ
levelinfo -pg 1 -10 190 470 580 -top -20 -bot 190
",
}
...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: outer_concat, and set properties
  set outer_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 outer_concat ]
...
CONFIG.NUM_MI {3} \
  ...
  # Create instance: pynq_concat, and set properties
  set pynq_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 pynq_concat ]

  # Create instance: pynq_interrupts, and set properties
  set pynq_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 pynq_interrupts ]
  set_property -dict [ list \
CONFIG.C_IRQ_CONNECTION {1} \
 ] $pynq_interrupts

  # Create instance: pynq_test_1, and set properties
  set pynq_test_1 [ create_bd_cell -type ip -vlnv user.org:user:pynq_test:1.0 pynq_test_1 ]
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins pynq_test_1/S_AXI_CTRL]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins hier/S_AXI_CTRL] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins pynq_interrupts/s_axi]
  connect_bd_intf_net -intf_net pynq_test_0_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S00_AXI] [get_bd_intf_pins pynq_test_1/M_AXI_DRAM]
  connect_bd_intf_net -intf_net pynq_test_0_M_AXI_OUT [get_bd_intf_pins pynq_test_1/M_AXI_OUT] [get_bd_intf_pins pynq_test_1/S_AXI_IN]
  connect_bd_intf_net -intf_net pynq_test_2_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins hier/M_AXI_DRAM]

  # Create port connections
  connect_bd_net -net axi_intc_0_irq [get_bd_pins pynq_interrupts/irq] [get_bd_pins system_concat/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins hier/clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_interrupts/s_axi_aclk] [get_bd_pins pynq_test_1/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pynq_test_1_interrupt_bus [get_bd_pins outer_concat/In0] [get_bd_pins pynq_test_1/interrupt_bus]
  connect_bd_net -net pynq_test_1_interrupt_wire [get_bd_pins outer_concat/In1] [get_bd_pins pynq_test_1/interrupt_wire]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins hier/reset_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_interrupts/s_axi_aresetn] [get_bd_pins pynq_test_1/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins pynq_concat/dout] [get_bd_pins pynq_interrupts/intr]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins system_concat/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins outer_concat/dout] [get_bd_pins pynq_concat/In0]
  connect_bd_net -net xlconcat_3_dout [get_bd_pins hier/dout] [get_bd_pins pynq_concat/In1]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41800000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_interrupts/S_AXI/Reg] SEG_axi_intc_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_test_1/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test_1_S_AXI_CTRL_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier/pynq_test_2/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test_2_S_AXI_CTRL_reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces pynq_test_1/M_AXI_DRAM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces hier/pynq_test_2/M_AXI_DRAM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 110 -defaultsOSRD
preplace inst system_concat -pg 1 -lvl 4 -y 390 -defaultsOSRD
preplace inst pynq_concat -pg 1 -lvl 2 -y 560 -defaultsOSRD
preplace inst pynq_interrupts -pg 1 -lvl 3 -y 550 -defaultsOSRD
preplace inst hier -pg 1 -lvl 6 -y 340 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 190 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 180 -defaultsOSRD
preplace inst pynq_test_1 -pg 1 -lvl 3 -y 140 -defaultsOSRD
preplace inst outer_concat -pg 1 -lvl 1 -y 440 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -y 200 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 700
preplace netloc processing_system7_0_DDR 1 5 9 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ 120 NJ
preplace netloc pynq_test_1_interrupt_wire 1 0 4 20 20 NJ 20 NJ 20 1100
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 730 40 1090
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 420 0 NJ 0 NJ 0 NJ 0 1860
preplace netloc xlconcat_1_dout 1 4 1 1410J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 360 390J 440 NJ 440 NJ 440 NJ 440 1860
preplace netloc pynq_test_0_M_AXI_DRAM 1 3 1 N
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 4 720J 330 NJ 330 NJ 330 1870
preplace netloc xlconcat_3_dout 1 1 6 420 450 NJ 450 NJ 450 NJ 450 NJ 450 2160
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 3 400 30 NJ 30 1110
preplace netloc xlconcat_0_dout 1 2 1 710
preplace netloc processing_system7_0_FIXED_IO 1 5 9 NJ 140 NJ 140 NJ 140 NJ 140 NJ 140 NJ 140 NJ 140 NJ 140 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 5 400 370 730 340 1130 340 NJ 340 1870
preplace netloc pynq_test_1_interrupt_bus 1 0 4 40 350 NJ 350 NJ 350 1090
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 40 10 410 10 710 10 1120 10 1410 10 1880
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 700
preplace netloc xlconcat_2_dout 1 1 1 380
preplace netloc axi_intc_0_irq 1 3 1 1110
preplace netloc pynq_test_2_M_AXI_DRAM 1 3 4 1130 30 NJ 30 NJ 30 2160
levelinfo -pg 1 0 210 560 910 1270 1640 2030 2180 2230 2280 2330 2380 2430 2480 2520 -top -10 -bot 640
",
}
