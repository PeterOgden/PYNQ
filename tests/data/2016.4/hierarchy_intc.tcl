...
################################################################
# This is a generated script based on design: hierarchy_intc
#
...
# source hierarchy_intc_script.tcl
...
set design_name hierarchy_intc
...
proc create_hier_cell_hier { parentCell nameHier } {
  ...
  # Create instance: hier_concat, and set properties
  set hier_concat [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 hier_concat ]

  # Create instance: hier_interrupts, and set properties
  set hier_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_intc:4.1 hier_interrupts ]
...
CONFIG.C_IRQ_CONNECTION {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins hier_interrupts/s_axi]

  # Create port connections
  connect_bd_net -net axi_intc_0_irq [get_bd_pins interrupt] [get_bd_pins hier_interrupts/irq]
  connect_bd_net -net inner_interrupt_bus [get_bd_pins hier_concat/In0] [get_bd_pins inner/interrupt_bus]
  connect_bd_net -net inner_interrupt_wire [get_bd_pins hier_concat/In1] [get_bd_pins inner/interrupt_wire]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins clock] [get_bd_pins hier_interrupts/s_axi_aclk] [get_bd_pins inner/clock]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins reset_n] [get_bd_pins hier_interrupts/s_axi_aresetn] [get_bd_pins inner/reset_n]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins hier_concat/dout] [get_bd_pins hier_interrupts/intr]
...
#  -string -flagsOSRD
preplace port M_AXI_DRAM -pg 1 -y 60 -defaultsOSRD
preplace port gpio_in -pg 1 -y 130 -defaultsOSRD
preplace port S_AXI_CTRL -pg 1 -y 70 -defaultsOSRD
preplace port s_axi -pg 1 -y 20 -defaultsOSRD
preplace port clock -pg 1 -y 150 -defaultsOSRD
preplace port reset_n -pg 1 -y 170 -defaultsOSRD
preplace port interrupt -pg 1 -y 140 -defaultsOSRD
preplace inst hier_concat -pg 1 -lvl 2 -y 170 -defaultsOSRD
preplace inst hier_interrupts -pg 1 -lvl 3 -y 140 -defaultsOSRD
preplace inst inner -pg 1 -lvl 1 -y 120 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 0 3 10J 10 NJ 10 580J
preplace netloc inner_M_AXI_OUT 1 0 2 20 20 380
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 1 NJ
preplace netloc inner_interrupt_wire 1 1 1 380
preplace netloc xlconcat_0_dout 1 2 1 N
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 3 10 230 NJ 230 580J
preplace netloc inner_M_AXI_DRAM 1 1 3 390J 60 NJ 60 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 220 390J 110 570J
preplace netloc axi_intc_0_irq 1 3 1 NJ
preplace netloc inner_interrupt_bus 1 1 1 380
preplace netloc xlslice_0_Dout 1 0 1 NJ
levelinfo -pg 1 -10 200 480 680 800 -top 0 -bot 240
",
}
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins hier/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  ...
  # Create port connections
  connect_bd_net -net axi_intc_0_irq [get_bd_pins hier/interrupt] [get_bd_pins system_concat/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins hier/clock] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_test/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins hier/reset_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_test/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41800000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs hier/hier_interrupts/S_AXI/Reg] SEG_axi_intc_0_Reg
...
preplace inst system_concat -pg 1 -lvl 4 -y 590 -defaultsOSRD
preplace inst hier -pg 1 -lvl 6 -y 350 -defaultsOSRD
preplace inst pynq_slice -pg 1 -lvl 2 -y 740 -defaultsOSRD
...
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 4 NJ 390 1100J 170 NJ 170 1940
preplace netloc processing_system7_0_DDR 1 5 4 1920J 230 NJ 230 NJ 230 2350J
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 710 200 1080
preplace netloc processing_system7_0_GPIO_O 1 1 5 400 540 NJ 540 NJ 540 NJ 540 1900
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 390 210 NJ 210 NJ 210 NJ 210 1890
preplace netloc xlconcat_1_dout 1 4 1 1440
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 530 NJ 530 NJ 530 NJ 530 NJ 530 1890
preplace netloc pynq_test_0_M_AXI_DRAM 1 3 1 1110
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1440
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 4 NJ 370 1090J 160 NJ 160 1950
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 3 370 650 NJ 650 1110J
preplace netloc processing_system7_0_FIXED_IO 1 5 4 1930J 250 NJ 250 NJ 250 2340J
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 5 390 670 700 670 1130 670 NJ 670 1940
preplace netloc inner_M_AXI_DRAM 1 3 4 1130 130 NJ 130 NJ 130 2220
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 130 380 130 690 220 1120 200 1450 200 1910
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 680
preplace netloc axi_intc_0_irq 1 3 4 1140J 510 NJ 510 NJ 510 2220
preplace netloc xlslice_0_Dout 1 2 4 NJ 740 NJ 740 NJ 740 1950
levelinfo -pg 1 0 200 540 900 1300 1670 2090 2270 2320 2370 -top 0 -bot 800
",
}
