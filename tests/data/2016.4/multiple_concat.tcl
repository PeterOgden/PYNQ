...
################################################################
# This is a generated script based on design: multiple_concat
#
...
# source multiple_concat_script.tcl
...
set design_name multiple_concat
...
CONFIG.C_IRQ_CONNECTION {1} \
  ...
  # Create instance: pynq_test_1_interrupts, and set properties
  set pynq_test_1_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 pynq_test_1_interrupts ]
  ...
  # Create instance: pynq_test_2_interrupts, and set properties
  set pynq_test_2_interrupts [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat:2.1 pynq_test_2_interrupts ]
...
CONFIG.NUM_PORTS {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pynq_test_2/S_AXI_CTRL]
  ...
  connect_bd_intf_net -intf_net pynq_test_2_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins pynq_test_2/M_AXI_DRAM]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_interrupts/s_axi_aclk] [get_bd_pins pynq_test_1/clock] [get_bd_pins pynq_test_2/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net pynq_test_1_interrupt_bus [get_bd_pins pynq_test_1/interrupt_bus] [get_bd_pins pynq_test_1_interrupts/In0]
  connect_bd_net -net pynq_test_1_interrupt_wire [get_bd_pins pynq_test_1/interrupt_wire] [get_bd_pins pynq_test_1_interrupts/In1]
  connect_bd_net -net pynq_test_2_interrupt_bus [get_bd_pins pynq_test_2/interrupt_bus] [get_bd_pins pynq_test_2_interrupts/In0]
  connect_bd_net -net pynq_test_2_interrupt_wire [get_bd_pins pynq_test_2/interrupt_wire] [get_bd_pins pynq_test_2_interrupts/In1]
  ...
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_interrupts/s_axi_aresetn] [get_bd_pins pynq_test_1/reset_n] [get_bd_pins pynq_test_2/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  connect_bd_net -net xlconcat_2_dout [get_bd_pins pynq_concat/In0] [get_bd_pins pynq_test_1_interrupts/dout]
  connect_bd_net -net xlconcat_3_dout [get_bd_pins pynq_concat/In1] [get_bd_pins pynq_test_2_interrupts/dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_test_2/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test_2_S_AXI_CTRL_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pynq_test_1/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test_S_AXI_CTRL_reg
  ...
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces pynq_test_2/M_AXI_DRAM] [get_bd_addr_segs processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
...
preplace inst pynq_test_2 -pg 1 -lvl 1 -y 40 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 490 -defaultsOSRD
preplace inst system_concat -pg 1 -lvl 6 -y 140 -defaultsOSRD
preplace inst pynq_concat -pg 1 -lvl 3 -y -110 -defaultsOSRD
preplace inst pynq_test_1_interrupts -pg 1 -lvl 2 -y -100 -defaultsOSRD
preplace inst pynq_interrupts -pg 1 -lvl 3 -y 80 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y 330 -defaultsOSRD
preplace inst pynq_test_2_interrupts -pg 1 -lvl 2 -y 60 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 5 -y 330 -defaultsOSRD
preplace inst pynq_test_1 -pg 1 -lvl 4 -y 120 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 7 -y 350 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 2 650 0 940
preplace netloc processing_system7_0_DDR 1 7 1 NJ
preplace netloc pynq_test_1_interrupt_wire 1 1 4 410 530 NJ 530 NJ 530 1340
preplace netloc pynq_test_0_M_AXI_OUT 1 3 2 980 20 1340
preplace netloc processing_system7_0_M_AXI_GP0 1 2 6 650J 170 950J 220 1350J 180 1670J 220 N 220 2300
preplace netloc pynq_test_2_M_AXI_OUT 1 0 2 10 140 380
preplace netloc xlconcat_1_dout 1 6 1 1850
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 8 20 400 380J 520 NJ 520 NJ 520 NJ 520 NJ 520 N 520 2300
preplace netloc pynq_test_0_M_AXI_DRAM 1 4 1 1360
preplace netloc axi_mem_intercon_M00_AXI 1 5 2 N 330 N
preplace netloc ps7_0_axi_periph_M01_AXI 1 0 4 -10 370 NJ 370 610 490 930
preplace netloc xlconcat_3_dout 1 2 1 620
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 4 N 510 650J 510 NJ 510 1390
preplace netloc xlconcat_0_dout 1 2 2 640 -50 950
preplace netloc processing_system7_0_FIXED_IO 1 7 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 0 5 20 310 390 310 630 500 980 340 1360
preplace netloc pynq_test_1_interrupt_bus 1 1 4 380 -40 NJ -40 NJ -40 1350
preplace netloc pynq_test_2_interrupt_bus 1 1 1 390
preplace netloc processing_system7_0_FCLK_CLK0 1 0 8 0 390 N 390 620 160 960 0 1380 0 N 0 1860 0 2310
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 970
preplace netloc pynq_test_2_interrupt_wire 1 1 1 400
preplace netloc xlconcat_2_dout 1 2 1 610
preplace netloc axi_intc_0_irq 1 3 3 950J -30 NJ -30 1670
preplace netloc pynq_test_2_M_AXI_DRAM 1 1 4 NJ -10 NJ -10 NJ -10 1370
levelinfo -pg 1 -30 200 510 790 1160 1530 1760 2080 2330 -top -240 -bot 580
",
}
