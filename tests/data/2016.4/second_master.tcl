...
################################################################
# This is a generated script based on design: second_master
#
...
# source second_master_script.tcl
...
CONFIG.NUM_MI {1} \
  ...
  # Create instance: jtag_pynq_test, and set properties
  set jtag_pynq_test [ create_bd_cell -type ip -vlnv user.org:user:pynq_test:1.0 jtag_pynq_test ]

  # Create instance: my_ps, and set properties
  set my_ps [ create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 my_ps ]
  set_property -dict [ list \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M00_AXI [get_bd_intf_pins axi_mem_intercon/M00_AXI] [get_bd_intf_pins my_ps/S_AXI_HP0]
  ...
  connect_bd_intf_net -intf_net jtag_axi_0_axi_periph_M00_AXI [get_bd_intf_pins jtag_axi_0_axi_periph/M00_AXI] [get_bd_intf_pins jtag_pynq_test/S_AXI_CTRL]
  connect_bd_intf_net -intf_net jtag_pynq_test_M_AXI_DRAM [get_bd_intf_pins axi_mem_intercon/S01_AXI] [get_bd_intf_pins jtag_pynq_test/M_AXI_DRAM]
  connect_bd_intf_net -intf_net jtag_pynq_test_M_AXI_OUT [get_bd_intf_pins jtag_pynq_test/M_AXI_OUT] [get_bd_intf_pins jtag_pynq_test/S_AXI_IN]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins my_ps/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins my_ps/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins my_ps/M_AXI_GP0] [get_bd_intf_pins ps7_0_axi_periph/S00_AXI]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins jtag_axi_0_axi_periph/ACLK] [get_bd_pins jtag_axi_0_axi_periph/M00_ACLK] [get_bd_pins jtag_axi_0_axi_periph/S00_ACLK] [get_bd_pins jtag_pynq_test/clock] [get_bd_pins my_ps/FCLK_CLK0] [get_bd_pins my_ps/M_AXI_GP0_ACLK] [get_bd_pins my_ps/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pynq_test/clock] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins my_ps/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins jtag_axi_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins jtag_axi_0_axi_periph/M00_ARESETN] [get_bd_pins jtag_axi_0_axi_periph/S00_ARESETN] [get_bd_pins jtag_pynq_test/reset_n] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pynq_test/reset_n] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x44A00000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs jtag_pynq_test/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_jtag_pynq_test_S_AXI_CTRL_reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces jtag_pynq_test/M_AXI_DRAM] [get_bd_addr_segs my_ps/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_my_ps_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces my_ps/Data] [get_bd_addr_segs pynq_test/S_AXI_CTRL/S_AXI_CTRL_reg] SEG_pynq_test_S_AXI_CTRL_reg
  create_bd_addr_seg -range 0x40000000 -offset 0x00000000 [get_bd_addr_spaces pynq_test/M_AXI_DRAM] [get_bd_addr_segs my_ps/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_my_ps_HP0_DDR_LOWOCM
...
preplace inst jtag_pynq_test -pg 1 -lvl 3 -y -110 -defaultsOSRD
preplace inst jtag_axi_0 -pg 1 -lvl 2 -y 40 -defaultsOSRD
preplace inst my_ps -pg 1 -lvl 5 -y 340 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 330 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -y 330 -defaultsOSRD
preplace inst jtag_axi_0_axi_periph -pg 1 -lvl 6 -y -70 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 5 5 NJ 260 NJ 260 NJ 260 NJ 260 NJ
preplace netloc jtag_pynq_test_M_AXI_DRAM 1 3 1 1120
preplace netloc jtag_axi_0_axi_periph_M00_AXI 1 2 5 690 -230 NJ -230 NJ -230 NJ -230 2180
preplace netloc pynq_test_0_M_AXI_OUT 1 2 2 730 0 1100
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 390 -220 NJ -220 NJ -220 NJ -220 1860
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 400 370J 480 NJ 480 NJ 480 NJ 480 1860
preplace netloc jtag_axi_0_M_AXI 1 2 4 690J -10 NJ -10 NJ -10 1870
preplace netloc pynq_test_0_M_AXI_DRAM 1 3 1 1110
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 N
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 5 390 510 NJ 510 1110 510 NJ 510 1890
preplace netloc jtag_pynq_test_M_AXI_OUT 1 2 2 730 -210 1100
preplace netloc processing_system7_0_FIXED_IO 1 5 5 NJ 280 NJ 280 NJ 280 NJ 280 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 5 380 530 710 530 1140 530 NJ 530 1900
preplace netloc processing_system7_0_FCLK_CLK0 1 0 6 20 370 370 -30 700 200 1130 -30 1420 -30 1880
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 720
levelinfo -pg 1 0 200 550 920 1280 1640 2040 2200 2250 2300 2340 -top -240 -bot 580
",
}
